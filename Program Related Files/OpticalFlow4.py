...
def main(x,y):
    cap = cv2.VideoCapture('/home/apoorv/Desktop/output.avi')
    ...
    while(True):
        ...
        if setting_up_next_digit == 1:
            ...
            if out_of_radius_next_digit == 1:
                is_stationary_next_digit = check_if_stationary(good_new,stationary_time)
            ...
            is_stationary = check_if_stationary(good_new,stationary_time)
